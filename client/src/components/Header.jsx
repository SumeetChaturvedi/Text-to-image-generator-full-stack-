...
const Header = () => {
    ...
    return (
            ...
            <motion.h1 className="text-4xl sm:text-7xl max-w-[300px] sm:max-w-[590px] mx-auto mt-10 text-center">
            ...
            >From imagination to masterpiece — turn simple text into breathtaking art with AI, instantly.
            </motion.p>
            ...
            >
                ...
                className='flex flex-wrap justify-center mt-16 gap-3'>
                    {Array(6).fill('').map((item, index)=>(
                        ...
                        duration-300 cursor-pointer max-sm:w-10' src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1}
